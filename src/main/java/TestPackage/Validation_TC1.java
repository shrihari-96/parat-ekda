...
public class Validation_TC1 extends BaseClass{
...
//		Thread.sleep(3000);
		...
		LP.emailInsertion(UtilityClass.readExcelDataInString("Login", 1, 0));
		UtilityClass.screenShot(driver, "Hari", "userID", "jpeg");
		LP.passwordInsertion(UtilityClass.readExcelDataInString("Login", 1, 1));
